...
{
    public partial class FilmInStock
    {
        ...
        public FilmInStock(SampleDbContext context)
        {
            this.context = context;
        }

        ///<summary>execute command film_in_stock</summary>
        public int Execute(
            int? pFilmId, 
            int? pStoreId, 
            out int? pFilmCount
        )
        {
            ...
            var command = new MySqlCommand(@"film_in_stock");
