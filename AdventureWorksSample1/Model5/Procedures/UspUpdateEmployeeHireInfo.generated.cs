...
namespace Sample.Entities
{
    public partial class UspUpdateEmployeeHireInfo
    {
        ...
        )
        {
            ...
            var affected = context.Database.ExecuteSqlCommand(@"EXEC @return_value = [HumanResources].[uspUpdateEmployeeHireInfo] @BusinessEntityID = @BusinessEntityID, @JobTitle = @JobTitle, @HireDate = @HireDate, @RateChangeDate = @RateChangeDate, @Rate = @Rate, @PayFrequency = @PayFrequency, @CurrentFlag = @CurrentFlag",
            ...
            bool? currentFlag        )
        {
            ...
            var result = context.Database.SqlQuery<T>(@"EXEC [HumanResources].[uspUpdateEmployeeHireInfo] @BusinessEntityID = @BusinessEntityID, @JobTitle = @JobTitle, @HireDate = @HireDate, @RateChangeDate = @RateChangeDate, @Rate = @Rate, @PayFrequency = @PayFrequency, @CurrentFlag = @CurrentFlag"
