...
namespace Sample.Entities
{
    public partial class UspUpdatesalesordershipinfoNative
    {
        ...
        )
        {
            ...
            var affected = context.Database.ExecuteSqlCommand(@"EXEC @return_value = [Sales].[usp_UpdateSalesOrderShipInfo_native] @SalesOrderID = @SalesOrderID, @ShipDate = @ShipDate, @Comment = @Comment, @Status = @Status, @TaxRate = @TaxRate, @Freight = @Freight, @CarrierTrackingNumber = @CarrierTrackingNumber",
            ...
            string carrierTrackingNumber        )
        {
            ...
            var result = context.Database.SqlQuery<T>(@"EXEC [Sales].[usp_UpdateSalesOrderShipInfo_native] @SalesOrderID = @SalesOrderID, @ShipDate = @ShipDate, @Comment = @Comment, @Status = @Status, @TaxRate = @TaxRate, @Freight = @Freight, @CarrierTrackingNumber = @CarrierTrackingNumber"
