...
namespace Sample.Entities
{
    public partial class UspGetBillOfMaterials
    {
        ...
        )
        {
            ...
            var affected = context.Database.ExecuteSqlCommand(@"EXEC @return_value = [dbo].[uspGetBillOfMaterials] @StartProductID = @StartProductID, @CheckDate = @CheckDate",
                returnValue, p0, p1);
            ...
            DateTime? checkDate        )
        {
            ...
            var result = context.Database.SqlQuery<T>(@"EXEC [dbo].[uspGetBillOfMaterials] @StartProductID = @StartProductID, @CheckDate = @CheckDate"
                , p0, p1);
