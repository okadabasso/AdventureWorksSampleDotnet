...
namespace Sample.Entities
{
    public partial class UspGetManagerEmployees
    {
        ...
        )
        {
            ...
            var affected = context.Database.ExecuteSqlCommand(@"EXEC @return_value = [dbo].[uspGetManagerEmployees] @BusinessEntityID = @BusinessEntityID",
                returnValue, p0);
            ...
            int? businessEntityId        )
        {
            ...
            var result = context.Database.SqlQuery<T>(@"EXEC [dbo].[uspGetManagerEmployees] @BusinessEntityID = @BusinessEntityID"
                , p0);
