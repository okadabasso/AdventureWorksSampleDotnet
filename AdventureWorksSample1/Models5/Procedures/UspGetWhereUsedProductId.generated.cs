...
namespace AdventureWorks1.Models5
{
    public partial class UspGetWhereUsedProductId
    {
        ...
        ///<summary>execute command dbo.uspGetWhereUsedProductID</summary>
        public int Execute(
            int? startProductId, 
            DateTime? checkDate
        )
        {
            ...
            var affected = context.Database.ExecuteSqlCommand(@"EXEC @return_value = [dbo].[uspGetWhereUsedProductID]
...
@CheckDate = @CheckDate",
        ...
        ///<summary>execute query dbo.uspGetWhereUsedProductID</summary>
        ...
        )
        {
            ...
            var result = context.Database.SqlQuery<T>(@"EXEC [dbo].[uspGetWhereUsedProductID]
@StartProductID = @StartProductID,
@CheckDate = @CheckDate", 
                p0, 
                p1);
