...
namespace AdventureWorks1.Models5
{
    public partial class UspUpdatesalesordershipinfoOndisk
    {
        ...
        ///<summary>execute command Sales.usp_UpdateSalesOrderShipInfo_ondisk</summary>
        public int Execute(
            int? salesOrderId, 
            DateTime? shipDate, 
            string comment, 
        ...
        )
        {
            ...
            var affected = context.Database.ExecuteSqlCommand(@"EXEC @return_value = [Sales].[usp_UpdateSalesOrderShipInfo_ondisk]
...
@CarrierTrackingNumber = @CarrierTrackingNumber",
        ...
        ///<summary>execute query Sales.usp_UpdateSalesOrderShipInfo_ondisk</summary>
        ...
        )
        {
            ...
            var result = context.Database.SqlQuery<T>(@"EXEC [Sales].[usp_UpdateSalesOrderShipInfo_ondisk]
@SalesOrderID = @SalesOrderID,
@ShipDate = @ShipDate,
@Comment = @Comment,
@Status = @Status,
