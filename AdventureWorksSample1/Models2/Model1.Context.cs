...
namespace AdventureWorksSample1.Models2
{
    ...
    public partial class AdventureWorksEdm : DbContext
    {
        public AdventureWorksEdm()
            : base("name=AdventureWorksEdm")
        {
        }
        ...
        [DbFunction("AdventureWorksEdm", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorksEdm].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
    
        [DbFunction("AdventureWorksEdm", "vSalesOrderDetail_extended_inmem")]
        public virtual IQueryable<vSalesOrderDetail_extended_inmem_Result> vSalesOrderDetail_extended_inmem()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<vSalesOrderDetail_extended_inmem_Result>("[AdventureWorksEdm].[vSalesOrderDetail_extended_inmem]()");
        }
    
        [DbFunction("AdventureWorksEdm", "vSalesOrderHeader_extended_inmem")]
        public virtual IQueryable<vSalesOrderHeader_extended_inmem_Result> vSalesOrderHeader_extended_inmem()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<vSalesOrderHeader_extended_inmem_Result>("[AdventureWorksEdm].[vSalesOrderHeader_extended_inmem]()");
        }
    
        [DbFunction("AdventureWorksEdm", "customerAccessPredicate")]
        public virtual IQueryable<customerAccessPredicate_Result> customerAccessPredicate(Nullable<int> territoryID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<customerAccessPredicate_Result>("[AdventureWorksEdm].[customerAccessPredicate](@TerritoryID)", territoryIDParameter);
        }
